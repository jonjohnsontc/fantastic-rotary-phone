// Recursive Solution from Book
// arrays store games starting in index 1, rather than index 0
// to match up with games played.
...
int solve(char outcome1[], char outcome2[], int goals1[], int goals2[], int i,
          int j) {
